import type { HistoricalStat, Organizer } from "@/types";
...
export const ORGANIZERS: Organizer[] = [
  { name: "Prof. Mirtha Torres", title: "Dirección General" },
  { name: "Tec. Pedro Oscar Bernachea", title: "Dirección General" },
  { name: "Lic. María de los Ángeles Bernachea", title: "Dirección General" },
];
...
export const OBJECTIVES = [
  "Crear y sostener un espacio de expresión artística para el canto y las danzas folclóricas, bajo el lema «Argentina le canta y baila a Latinoamérica».",
  "Impulsar el turismo cultural como herramienta de desarrollo local y regional.",
  "Favorecer la integración y el intercambio cultural entre los pueblos de Argentina y Latinoamérica.",
  "Promover la inclusión del Encuentro en los calendarios culturales y turísticos a nivel local, provincial y nacional.",
];

export const EVENT_TAGLINE = "Argentina le canta y baila a Latinoamérica";
export const EVENT_NAME = "Encuentro Latinoamericano del Canto y las Danzas Folclóricas";
export const ORGANIZED_BY = [
  'Ballet Folclórico "Embajada Folklórica Argentina"',
  '"Las 3 Marías" Eventos',
];
